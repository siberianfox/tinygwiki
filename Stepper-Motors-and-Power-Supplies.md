Since we get a lot of questions about what stepper motors and power supplies to use we've started this page. As of today (1/19/14) it's pretty sketchy but we'll fill this in.

# Stepper Motors

## Sources

Here are some sources that carry some good motors
* [Alltronics](http://www.alltronics.com/) See the OSM's in particular. Often have some interesting surplus Lin motors.
* 
