...
Alternately, the wiring or switches may be intermittent and firing randomly. An oscilloscope or VOM can be used to diagnose this case. If this happens try disconnecting one switch axis at a time and see if the problem goes away of gets better.
