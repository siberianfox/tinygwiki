**The settings on this page are for version 0.95.** Please use the links below if you are not on version 0.95. You can find out the firmware version by entering $fv or by looking at the console output when you hit reset.
