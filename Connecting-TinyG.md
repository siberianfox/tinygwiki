...
Most TinyG v7s and above have screw terminals and therefore do not need a motor connector kit. If you have a board that has quick release headers on it there are the mating parts. You need 4 terminals for each housing.
...
You can get these from Mouser or DigiKey. TE/Amp also makes some nice parts: TE/Amp 3-644463-4
