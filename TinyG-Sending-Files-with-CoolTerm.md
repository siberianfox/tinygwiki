...
The "clear send buffer" would appear to solve this problem, but doesn't. Be ready with the emergency stop if you kill a partial job with the CoolTerm "cancel" button.
