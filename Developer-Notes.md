...
The best way to understand the code is to read it. It's pretty well commented. Here are some [additional notes](https://github.com/synthetos/TinyG/wiki/Developer-Notes-on-Modules) that explain some things that are too wordy for the code comments.
