**The settings on this page are for version 0.96 and later.** If you are an earlier revision see [here](https://github.com/synthetos/TinyG/wiki/TinyG-Configuration-for-0.95). You can find out the firmware version by entering $fv or by looking at the console output when you hit reset.
